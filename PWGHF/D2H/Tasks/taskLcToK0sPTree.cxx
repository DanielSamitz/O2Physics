  ...
  process(soa::Join<aod::HfCandCascFull, aod::HfSelLcToK0sP>const& candidates)
  {
    ...
    for (auto& candidate : candidates) {
      ...
      */
      ...
      auto mK0Short = candidate.v0MK0Short();
      ...
      auto tpcNSigmaPr = candidate.nSigmaTPCPr0();
      auto tofNSigmaPr = candidate.nSigmaTOFPr0();
      auto pBach = candidate.pProng0();
