...
struct lmeelfcocktailaodold {
  ...
  PROCESS_SWITCH(lmeelfcocktailaodold, processPairing, "Process pairing", false);
  PROCESS_SWITCH(lmeelfcocktailaodold, processCocktail, "Process cocktail", true);
};
...
{
  WorkflowSpec specs;
  DataProcessorSpec dSpec = adaptAnalysisTask<lmeelfcocktailaodold>(cfgc, TaskName{"em-lmee-lf-cocktail-aod-old"});
